...
public class Superstructure extends SubsystemBase {
    ...
    public Superstructure(Drivetrain drivetrain, Intake intake, Shooter shooter, Turret turret) {
    ...
    public void setRobotState(RobotState state) {
        if ((state == RobotState.INTAKING && robotState == RobotState.SHOOTING) || (state == RobotState.SHOOTING && robotState == RobotState.INTAKING)) {
    ...
    public void idleIntake() {
        // Set intake rollers to 0.
        // Set intake sliding motor to defined voltage.
    }

    public void intake() {
        // Set intake rollers to defined voltage.
        // Set intake sliding motor to defined voltage.
    }
    ...
    public void periodic() {
        ...
        shotAnglePublisher.set(shotData.shotAngle().getDegrees());
